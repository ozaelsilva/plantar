...
type
  ...
  public
    ...
    function RecuperarIdentificador(sNomeGEN: String): Integer;
...
function TdmPrincipal.RecuperarIdentificador(sNomeGEN : String) : Integer;
begin
  with qryAux do
  begin
    Close;
    ...
    SQL.Add('SELECT GEN_ID(' + sNomeGEN + ', 0) FROM RDB$DATABASE' );
